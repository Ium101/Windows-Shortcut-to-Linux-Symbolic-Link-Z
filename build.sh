#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────
#  build.sh  —  Creates Lnk2SymLnk launcher script in THIS folder
#  Run:    chmod +x build.sh && ./build.sh
#  Output: Lnk2SymLnk   (executable launcher, right here)
# ─────────────────────────────────────────────────────────────────
set -euo pipefail
cd "$(dirname "$0")"
...
# ── Write the launcher ───────────────────────────────────────────
echo " Writing Lnk2SymLnk..."

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"

cat > Lnk2SymLnk << LAUNCHER
#!/usr/bin/env bash
...
echo " =========================================="
echo
echo "  Launcher:  $SCRIPT_DIR/Lnk2SymLnk"
...
echo
echo " To run:"
echo "    ./Lnk2SymLnk                      # open GUI"
echo "    ./Lnk2SymLnk --no-gui [DIR]       # CLI mode"
echo "    ./Lnk2SymLnk --lang pt            # Portuguese UI"
echo "    ./Lnk2SymLnk --help               # all options"
echo
